...
return [
    ...
    */
    ...
    'apps' => [
        [
            'id' => env('PUSHER_APP_ID', 'forumapp'),
            'name' => env('APP_NAME', 'Forum'),
            'host' => env('PUSHER_APP_HOST'),
            'key' => env('PUSHER_APP_KEY', 'forumkey123'),
            'secret' => env('PUSHER_APP_SECRET', 'forumsecret123'),
    ...
    */
    ...
    // Keep connections alive — prevents 10-15 second drops
    'ping_interval' => 25,      // server pings client every 25 seconds
    'pong_timeout'  => 10,      // client must respond within 10 seconds

    // Maximum time a connection can stay open (seconds)
    'max_request_size_in_kb' => 250,
